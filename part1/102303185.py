...
def validate_inputs(args):
    if len(args) != 5:
        print("Usage: python 102303185.py <SingerName> <NumberOfVideos> <AudioDuration> <OutputFileName>")
        print('Example: python 102303185.py "Sharry Maan" 20 20 102303185-output.mp3')
        sys.exit(1)
